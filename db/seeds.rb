...
second_event = Event.new(user_id: user.id, name: "ROTIMI FANI-KAYODE", location: "22 Rose Street, Edinburgh, EH22QA", description: rfk_description, price: 3.50, date: "October 16th")
...
fourth_event = Event.new(user_id: user.id, name: "MASS INCARCERATION IN THE US", location: "131 Warrender Park Road, Edinburgh", description: ses_description, price: 12.00, date: "October 22nd")
...
fifth_event = Event.new(user_id: user.id, name: "DUMP DONALD - ART & TRUMP", location: "43 Dublin Street, Edinburgh, EH36NL", description: ta_description, price: 6.00, date: "October 8th")
...
sixth_event = Event.new(user_id: user.id, name: "SOCIAL!!", location: "Edinburgh Castle, Edinburgh", description: games_description, price: 4.00, date: "September 17th")
...
seventh_event = Event.new(user_id: user.id, name: "SOCIAL!!", location: "6 Chester Street, Edinburgh, Eh37RA", description: devon_description, price: 3.00, date: "October 2nd")
...
eigth_event = Event.new(user_id: user.id, name: "SOCIAL!!", location: "14 Bellevue Terrace, Edinburgh, EH74DS", description: frankies_description, price: 2.00, date: "November 4th")
